...
const dateRangeFilter: FilterFn<Record<string, unknown>> = (row, columnId, filterValue: DateRangeFilter) => {
                            ...
                            <div className="flex gap-1">
                              <Input
                                ...
                                onChange={(e) => {
                                  ...
                                  header.column.setFilterValue({ ...rangeValue, from });
                                }}
                                className="h-8 text-xs border-gray-200 focus:ring-teal-300 w-1/2"
                              />
                              <Input
                                ...
                                onChange={(e) => {
                                  ...
                                  header.column.setFilterValue({ ...rangeValue, to });
                                }}
                                className="h-8 text-xs border-gray-200 focus:ring-teal-300 w-1/2"
                              />
                            </div>
